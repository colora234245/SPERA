...
module.exports = {
    name: "Kışkırtma, Trol (5 dk.)",
    description: "Bir uyenin sunucu icerisindeki verilerini gosterir.",
    type: 'MESSAGE',
    /**
     *
     * @param {Client} client
    ...
    run: async (client, int, args) => {
        ...
        return uye.addPunitives(5, yetkili, "Kışkırtma, Trol ve Rahatsız Edici Davranış!", message, "5m")
    }
};