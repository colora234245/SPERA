...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
	...
	message.reply({embeds: [new genEmbed().setDescription(`${uye} üyesinin toplamda **${isimveri.Names.length || 0}** isim kayıtı bulundu.\n${isimler}`)]})
    } else {
         message.reply({embeds: [new genEmbed().setDescription(`${uye} üyesinin isim kayıtı bulunamadı.`)]});
     }
    }
};